...
export default function middleware(request: NextRequest) {
  ...
  // Auth gate: protected routes require a Supabase session cookie. The actual
  // session validity check is performed in the server layout for the relevant
  // route group; this middleware just short-circuits unauthenticated visitors
  // to the sign-in page so they never see a render of protected UI.
